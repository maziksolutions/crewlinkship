...
namespace crewlinkship.Controllers
{
    public class PortagebillController : Controller
    {
        ...
        {
            int vesselId = 125; int month = 2; int year = 2023; string checkpbtilldate = "";
            var data = _context.PortageBillVM.FromSqlRaw<PortageBillVM>("getPortageBill @p0, @p1, @p2, @p3, @p4", vesselId, month, year, "no", checkpbtilldate);
